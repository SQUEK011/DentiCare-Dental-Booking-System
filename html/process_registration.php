<?php
  ...
  if(mysqli_num_rows(mysqli_query($conn,$query)) < 1) {
    ...
    if(mysqli_num_rows(mysqli_query($conn,$query)) < 1){
      ...
      echo '<script type="text/javascript"> alert("Full Name/NRIC already exists!");</script>';
      echo '<script type="text/javascript"> window.open("registration.php","_self");</script>';   
    }
    
    
  }else {
    echo '<script type="text/javascript"> alert("Username/Email already exists!");</script>';
      echo '<script type="text/javascript"> window.open("registration.php","_self");</script>';   
  }
